...
public:
	...
	OneSensor list[SENSOR_COUNT] {
		...
		// Urban Sensors
		OneSensor {	BOARD_URBAN, 		SENSOR_NOISE, 						"Noise", 								29,			false,			"dBc", true},
		...
		OneSensor {	BOARD_URBAN, 		SENSOR_CO, 							"Carbon monoxide", 						16,			true,			"kOhm/ppm", true},
		...
		OneSensor {	BOARD_URBAN, 		SENSOR_NO2, 						"Nitrogen dioxide",						15,			true,			"kOhm/ppm", true},
